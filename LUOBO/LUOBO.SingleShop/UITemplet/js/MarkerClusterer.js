...
(function(){
    ...
    var MarkerClusterer =  
        ...
        BMapLib.MarkerClusterer = function(map, options){
            ...
            var that = this;
			this._zoomendFunction = function(){
                that._redraw();     
            };
            this._map.addEventListener("zoomend",this._zoomendFunction);
    
			this._moveendFunction = function(){
                 that._redraw();     
            };
            this._map.addEventListener("moveend",this._moveendFunction);
     ...
     * @return 无返回值
     */
    MarkerClusterer.prototype.clearEvent = function() {
        this._map.removeEventListener("zoomend", this._zoomendFunction);
		this._map.removeEventListener("moveend", this._moveendFunction);
    }
    ...
    function Cluster(markerClusterer){
		...
		this._zoomendFunction;
		this._moveendFunction;
    ...
    Cluster.prototype.updateClusterMarker = function () {
		...
		for(var i=0;i<this._markers.length;i++)
			tmp += parseInt(this._markers[i]._text);
		
        this._clusterMarker.setText(tmp);
