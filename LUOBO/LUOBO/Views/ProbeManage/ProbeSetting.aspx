...
<body>
    ...
    <div class="div-body" style="font-size:12px">
        <div id="tab1">
            ...
            <div id="tab1-1" style="height:180px">
                <table>
                    <tr>
                        <td>设备编号</td>
                    ...
                    <tr style="vertical-align:top">
                        ...
                        <td colspan="3" rowspan="2"><textarea id="txtDescription" rows="5" cols="50" ><%=((LUOBO.Entity.SYS_AP_VIEW)ViewData["APDEVICE"]).DESCRIPTION%></textarea></td>
                        <td>数据上报间隔</td>
                        <td><input id="txtDataInterval" class="txt-apreg" type="text" value="<%=((LUOBO.Entity.SYS_AP_VIEW)ViewData["APDEVICE"]).DATAINTERVAL%>"  /></td>
                        <td><input id="btnSaveBase" type="button" value="保存" /></td>
                    </tr>
                    <tr style="vertical-align:top">
                        <td></td>
                        <td>远程重启</td>
