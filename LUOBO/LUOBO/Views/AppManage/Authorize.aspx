...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function GetUserAppCompetence() {
            $.ajax({
                type: 'post', //可选get
                url: '/UsersManage/GetUserAppCompetence', //这里是接收数据的PHP程序
        ...
        function FindAppcompetencList() {
            ...
            $.ajax({
                type: 'post', //可选get
                url: '/UsersManage/FindAppcompetencList', //这里是接收数据的PHP程序
        ...
        function AddUserAppCompetence() {
            $.ajax({
                type: 'post', //可选get
                url: '/UsersManage/AddUserAppCompetence', //这里是接收数据的PHP程序
