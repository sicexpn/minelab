                ...
                success: function (obj) {
                    ...
                    if (obj.OrgList.length > 0) {
                        ...
                        for (var i = 0; i < obj.OrgList.length; i++) {
                            ...
                            result += "<td><a href='OrgEdit?id=" + item.ID + "'>修改</a> <a href='OrgAuthorize?id=" + item.ID + "'>授权</a></td>";
                            result += "</tr>";
...
<div class="container-fluid">
      <div  class="row-fluid">
        ...
        <div class="widget-container  clearfix">
            <div class="heading"><i class="fa fa-fw fa-list-ul"></i>机构管理
...
<thead>
                ...
                <tr>
                    <th style="width:70px" scope="col"><input id="checkAll" type="checkbox" value="全选 "/> 选择</th>
